<template>
  <router-link :to="`/user/${userId}`" tag="tr" class="md-table-row" :class="rowClasses" @click="onClick" v-on="$listeners">
...
<script>
import MdPropValidator from '@/../node_modules/vue-material/src/core/utils/MdPropValidator'
